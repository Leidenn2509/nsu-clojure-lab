...
(deftest parser-test
    (testing "Test parser func"
        ...
        (is (same-expr-strict? (parse "a>b>c") (dnf-impl (dnf-impl (variable :a) (variable :b)) (variable :c))))
        (is (same-expr-strict? (parse "a>-b>c") (dnf-impl (dnf-impl (variable :a) (dnf-not (variable :b))) (variable :c))))
